...
func (tx *Tx) init() {
	tx.DownloadQueueItem = NewDownloadQueueItemClient(tx.config)
	...
	tx.ProviderStorage = NewProviderStorageClient(tx.config)
...
// applies a query, for example: DownloadQueueItem.QueryXXX(), the query will be executed
