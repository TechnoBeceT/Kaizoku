...
func (_c *SourceEventCreate) SetStatus(v string) *SourceEventCreate {
...
func (_c *SourceEventCreate) createSpec() (*SourceEvent, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.Status(); ok {
		_spec.SetField(sourceevent.FieldStatus, field.TypeString, value)
		_node.Status = value
	}
...
// SetEventType sets the "event_type" field.
func (u *SourceEventUpsert) SetEventType(v string) *SourceEventUpsert {
...
// SetStatus sets the "status" field.
func (u *SourceEventUpsert) SetStatus(v string) *SourceEventUpsert {
...
// SetEventType sets the "event_type" field.
func (u *SourceEventUpsertOne) SetEventType(v string) *SourceEventUpsertOne {
	return u.Update(func(s *SourceEventUpsert) {
		s.SetEventType(v)
	})
}
...
// SetStatus sets the "status" field.
func (u *SourceEventUpsertOne) SetStatus(v string) *SourceEventUpsertOne {
	return u.Update(func(s *SourceEventUpsert) {
		s.SetStatus(v)
	})
}
...
// SetEventType sets the "event_type" field.
func (u *SourceEventUpsertBulk) SetEventType(v string) *SourceEventUpsertBulk {
	return u.Update(func(s *SourceEventUpsert) {
		s.SetEventType(v)
	})
}
...
// SetStatus sets the "status" field.
func (u *SourceEventUpsertBulk) SetStatus(v string) *SourceEventUpsertBulk {
	return u.Update(func(s *SourceEventUpsert) {
		s.SetStatus(v)
	})
}
