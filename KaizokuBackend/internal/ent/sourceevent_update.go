...
func (_u *SourceEventUpdate) SetStatus(v string) *SourceEventUpdate {
	_u.mutation.SetStatus(v)
	return _u
}

// SetNillableStatus sets the "status" field if the given value is not nil.
func (_u *SourceEventUpdate) SetNillableStatus(v *string) *SourceEventUpdate {
	if v != nil {
		_u.SetStatus(*v)
	}
	return _u
...
// SetStatus sets the "status" field.
func (_u *SourceEventUpdateOne) SetStatus(v string) *SourceEventUpdateOne {
	_u.mutation.SetStatus(v)
	return _u
}

// SetNillableStatus sets the "status" field if the given value is not nil.
func (_u *SourceEventUpdateOne) SetNillableStatus(v *string) *SourceEventUpdateOne {
	if v != nil {
		_u.SetStatus(*v)
	}
	return _u
